# Как использовать в файлах и ыункциях проекта:
# шаблон для синхронных функций:

  # 1 в основной код твоего файла прописываешь эти две строки:
    # просто добавить эти две строчки без изменений в импортах
    # from src.core.log_setup import get_logger
    # log = get_logger(__name__)

  # 2 пишем свою функцию и можем прописывать в ней логирование по такому принципу:
    # def your_function():                      # твоя функция
    #     try:
    #         log.info("Работаю")               # логгирование хода работы функции, выводит в терминал и пишет в файл
    #         1 / 0                             # просто иммитирую ошибку для наглядности
    #     except Exception:
    #         log.exception("Ошибка в run()")   # логгирование ошибки
    #         raise                             # если нужно пробросить ошибку и остановить код
    #         return None                       # если хочешь чтобы код продолжал работать, то вместо raise нужно return None
    
    # ну или просто без try/except
    # def your_function():                      # твоя функция
    #   log.info("Работаю")                     # логгирование хода работы функции, выводит в терминал и пишет в файл


# шаблон для асинхронных функций сделаю потом
