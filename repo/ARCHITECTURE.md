...
- “В избранное” → FavoritesService.add.
- “В чёрный список” → BlacklistService.add.
- "Показать избранное" → FavoritesService.list → inline-кнопки с VK ID; клик — показать анкету.
- "Удалить из избранного" → inline-кнопки с VK ID; клик — удалить и обновить список.
...
- Меню "Дополнительно": [В избранное] [В чёрный список] [Показать избранное] [Настроить фильтры поиска] [Назад]
- "Показать избранное": reply-клавиатура [Удалить из избранного] [Назад] + inline-кнопки с VK ID для просмотра анкеты
- "Удалить из избранного": reply-клавиатура [Назад] + inline-кнопки с VK ID для удаления
